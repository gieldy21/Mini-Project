...
public class GetAllOrders {
    ...
    @Step("I set GET endpoints orders without Authorazation")
    public String setGetApiEndpointOrdersWithoutAuthorization(){
        return url + "orders";
    }
    @Step("I send GET HTTP request orders without Authorazation")
    public String sendGetHttpRequestOrdersWithoutAuthorization(){
        SerenityRest.given().post(setGetApiEndpointOrdersWithoutAuthorization());
        return null;
    }
}
