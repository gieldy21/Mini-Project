...
//    }
//    @Step("I set POST endpoints order without Authorazation")
//    public String setPostApiEndpointOrderWithoutAuthorization(){
//        return url + "orders";
//    }
//    @Step("I send POST HTTP request order without Authorazation")
//    public String sendPostHttpRequestOrderWithoutAuthorization(){
//        SerenityRest.given().post(setPostApiEndpointOrderWithoutAuthorization());
//        return null;
//    }
}
